...
args = parser.parse_args(args=['--cfg_file', 'cfgs/default.yaml', '--ckpt', 'checkpoint_epoch_70.pth', '--batch_size', '1', '--eval_mode', 'rcnn'])
...
def eval_one_epoch_rpn(model, dataloader, epoch_id, result_dir, logger):
    ...
    for data in dataloader:
        sample_id_list, pts_rect, pts_features, pts_input =             data['sample_id'], data['pts_rect'], data['pts_features'], data['pts_input']
